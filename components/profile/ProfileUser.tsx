                ...
                <div className="flex flex-col items-center gap-4 mt-6">
                  ...
                  <button
                    ...
                    className={`
                        ...
                        bg-gray-100 dark:bg-gray-700 text-(--main-color) dark:text-white px-4 py-2 rounded-lg text-sm font-bold border border-(--main-color)/20 hover:bg-gray-800 transition
                        `}
                  >
